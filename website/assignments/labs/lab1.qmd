---
title: "DATA 622: Lab 1: Bias Variance Trade-Off "
format: html
---
...
This exercise involves the `Auto` data set studied in the interactive lab in chapter 2 of `ISLP`. Make sure
...
(b) The following code imports the `kNN` classification function from `scikit-learn` as well as an accuracy function, trains
