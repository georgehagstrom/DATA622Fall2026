...
We will use a dataset called `earnings`. It can be found on
...
(a) __Baseline Model:__ Start with a model that includes `age`, `gender`, `education`, fit a linear model and calculate the `AIC`.
