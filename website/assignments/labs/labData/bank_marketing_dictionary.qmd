...
this assignment, we are using the dataset in [bank_marketing_dataset.csv](https://github.com/georgehagstrom/DATA622Fall2026/blob/main/website/assignments/labs/labData/bank_marketing_dataset.csv).
