...
_Answering this is one of the main subjects of this class!_

1. Experimental Answers- save some data for testing and use that to estimate out of sample performance
  - Cross-Validation, Train-Test Split, bootstrapping

## What Complexity to Pick?

_Answering this is one of the main subjects of this class!_

2. Theoretical Answers- For statistical models there are _information criteria_ that tell us how to balance in-sample accuracy versus model complexity
  - AIC, BIC, WAIC, Mallow's P, etc
...
$$
g(\mathbf{x})_{kNN} = \mathrm{argmax}_{y}\sum_{\mathbf{x}_i \in N_k(\mathbf{x})} I(y = y_i)
$$
...
- Consider this general classification problem:

![](bayes_knn.png)

- Probability that $y=1$ proportional to distance from boundary


## kNN Bias-Variance Example

- When number of points is small

::: {.r-stack}
![](knn_rules_k1_n100.png)

![](knn_rules_kopt_n100.png){.fragment}

![](knn_rules_k30_n100.png){.fragment}
...
![](bias_variance_n100.png)

## kNN Bias-Variance

- When number of points is moderate

::: {.r-stack}
![](knn_rules_k1_n1000.png)

![](knn_rules_kopt_n1000.png){.fragment}

![](knn_rules_k300_n1000.png){.fragment}
...
![](bias_variance_n1000.png)


## kNN Bias-Variance Example

- When number of points is large

::: {.r-stack}
![](knn_rules_k1_n10000.png)

![](knn_rules_kopt_n10000.png){.fragment}

![](knn_rules_k3000_n10000.png){.fragment}
...
![](bias_variance_n10000.png)


## Did Complexity Increase With Data?
...
- Looks like $k$ went up.....


## Did Complexity Increase With Data?

| $n$     | $k_{\mathrm{opt}}$   | $r_{\mathrm{eff}} = \sqrt{k/(\pi n)}$ |
|---------|-------|------------------------|
| $100$   | $15$  | $0.21$            |
| $1000$  | $23$  | $0.086$           |
| $10000$ | $145$ | $0.068$           |

- Best measure of "complexity" here actually goes up
- Expected radius of circle that a test point "sees"
